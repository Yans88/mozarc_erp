...
Route::group(['prefix' => 'clients'], function () {
    ...
    Route::any("/{client}/{section}", "Clients@showDynamic")
        ...
        ->where(['client' => '[0-9]+', 'section' => 'contacts|comments|projects|files|tickets|invoices|expenses|payments|timesheets|estimates|notes']);
});
...
Route::group(['prefix' => 'projects'], function () {
    ...
    Route::get("/template-description", "Projects@templateDescription");
...
Route::group(['prefix' => 'tasks'], function () {
	...
	Route::post("/get-assigned", "Leads@getAssignedLead");
});
...
Route::group(['prefix' => 'feed'], function () {
    ...
    Route::get("/clients", "Feed@clients");
	
    Route::get("/department", "Feed@department");
...
Route::group(['prefix' => 'employee'], function () {
    ...
    Route::any("/search", "Employee@index");  
	
	Route::any("/save_employee", "Employee@store");
	
	Route::any("/save_dr", "Employee@store_dr");

    Route::any("/save_payment", "Employee@store_payment");
	
    Route::any("/save_review", "Employee@store_review");
	
	Route::any("/save_meeting_minutes", "Employee@store_mm");
	
	Route::get("/edit/{id}", "Employee@edit")->where('id', '[0-9]+');
	
	Route::post("/update/{id}", "Employee@update")->where('id', '[0-9]+');
	
	Route::any("/files", "Files@employee_files");
	
	Route::any("/{section}", "Employee@showDynamic")->where(['section' => 'daily_report|dr|payment|payment_content|meeting_minutes|meeting_m|review|review_content|employee-files']);
});
...
Route::group(['prefix' => 'groups'], function () {
    ...
    Route::any("/search", "Groups@index");	
	
	Route::get("/edit/{id}", "Groups@edit")->where('id', '[0-9]+');
	
	Route::post("/update/{id}", "Groups@update")->where('id', '[0-9]+');
	
	Route::get("/assign/{id}", "Groups@assign")->where('id', '[0-9]+');
	
	Route::post("/process_assign/{id}", "Groups@process_assign")->where('id', '[0-9]+');
	
	Route::post("/unassign/{id}", "Groups@unassign")->where('id', '[0-9]+');
...
Route::resource('rooms', 'Room');

Route::group(['prefix' => 'rooms'], function () {

    Route::any("/search", "Room@index");	
	
	Route::any("/save", "Room@store");   
	
	Route::any("/refresh/{id}", "Room@refresh")->where('id', '[0-9]+');
});

Route::group(['prefix' => 'grouprooms'], function () {

    Route::any("/search", "GroupRooms@index");	
	
	Route::get("/edit/{id}", "GroupRooms@edit")->where('id', '[0-9]+');
	
	Route::post("/update/{id}", "GroupRooms@update")->where('id', '[0-9]+');    

});

Route::resource('grouprooms', 'GroupRooms');
...
Route::group(['prefix' => 'grouprooms'], function () {
	...
	Route::get("/assign/{id}", "GroupRooms@assign")->where('id', '[0-9]+');
	
	Route::post("/process_assign/{id}", "GroupRooms@process_assign")->where('id', '[0-9]+');
	
	Route::post("/unassign/{id}", "GroupRooms@unassign")->where('id', '[0-9]+');    
...
Route::group(['prefix' => 'company'], function () {
    ...
    Route::any("/search", "Company@index");  
	
	Route::any("/save", "Company@store");
	
	Route::get("/edit/{id}", "Company@edit")->where('id', '[0-9]+');
	
	Route::post("/update/{id}", "Company@update")->where('id', '[0-9]+');	
