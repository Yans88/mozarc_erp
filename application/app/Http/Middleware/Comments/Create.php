...
class Create {
     ...
     *
     */
    public function __construct(ProjectPermissions $projectpermissons, CommentPermissions $commentpermissons) {
    ...
    public function handle($request, Closure $next) {
        ...
        }				 if (request('commentresource_type') == 'client') {            if ($this->commentpermissons->check('comments-post', request('commentresource_id'))) {                return $next($request);            }        }
