        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            if (request('action') == 'load') {
                ...
                if (request()->filled('source')) {
                    $name = request('source');
                    $board = $boards[$name];
                    $html = view('pages/leads/components/kanban/card', compact('board','percentage_checklist'))->render();
                ...
                $html = view($template, compact('page', 'boards', 'stats', 'categories', 'tags', 'statuses','percentage_checklist'))->render();
                $jsondata['dom_html'][] = array(
            ...
            return view('pages/leads/wrapper', compact('page', 'boards', 'stats', 'categories', 'tags', 'statuses','percentage_checklist'))->render();
        }
