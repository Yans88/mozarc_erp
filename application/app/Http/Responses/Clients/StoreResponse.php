...
class StoreResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if ($count == 1) {
            ...
            $html = view('pages/clients/components/table/table', compact('clients', 'categories'))->render();
            ...
            $html = view('pages/clients/components/table/ajax', compact('clients', 'categories'))->render();
