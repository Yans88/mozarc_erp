...
class IndexResponseEmp implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/employee/files/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/employee/files/components/table/table';
            ...
            default:
                $template = 'pages/employee/files/tabswrapper';
            ...
            return view('pages/employee/files/wrapper', compact('page', 'files', 'tags'))->render();
        }
