...
class CreateResponseLeads implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //render the form
        $html = view('pages/leads/components/modals/add-edit-task-inc', compact('page', 'tags', 'milestones', 'fields','assigned'))->render();
