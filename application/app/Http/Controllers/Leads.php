...
class Leads extends Controller {
     ...
     * 
     * @param object TaskRepository instance of the repository
    ...
    public function show(
        ...
        $tasks = $taskrepo->search();

        foreach ($tasks as $task) {

            $this->applyTaskPermissions($task);
     ...
     * @param object task instance of the resource model object

     * @return object

     */

    private function applyTaskPermissions($task = '') {
        ...
        if ($task instanceof \App\Models\Task) {
            ...
            $task->permission_edit_delete_task = $this->taskpermissions->check('edit-delete', $task);
