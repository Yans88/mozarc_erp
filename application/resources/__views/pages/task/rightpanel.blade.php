            ...
            <table class="table table-bordered table-sm">
                ...
                <tbody>
                    ...
                    <tr>
						...
						@if($task->task_private > 0)
							<tr>

								<td>{{ cleanLang(__('lang.private')) }}</td>
						...
						@if($task->task_leadid > 0)
							<tr>

								<td>{{ cleanLang(__('lang.lead')) }}</td>

								<td><strong><a href="{{ urlResource('/leads/v/'.$task->task_leadid.'/'.$task->lead_company_name) }}"

											target="_blank">{{ $task->task_leadid }}</a></strong>
						...
						@if($task->task_clientid  > 0)
							<tr>

								<td>{{ cleanLang(__('lang.client')) }}</td>

								<td><strong><a href="{{ urlResource('/clients/'.$task->task_clientid) }}"

											target="_blank">#{{ $task->task_clientid }}</a></strong>
						...
						@if($task->task_departmentid  > 0)
							<tr>

								<td>{{ cleanLang(__('lang.department')) }}</td>

								<td><strong>{{ $task->role_name }}</strong>
