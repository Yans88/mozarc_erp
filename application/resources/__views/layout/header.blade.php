<head>
    ...
    <script src="mozarc_work/public/vendor/js/vendor.header.js?v={{ config('system.versioning') }}"></script>
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="mozarc_work/public/vendor/css/vendor.css?v={{ config('system.versioning') }}">

    <!--ICONS-->
    <link rel="stylesheet" href="mozarc_work/public/vendor/fonts/growcrm-icons/styles.css?v={{ config('system.versioning') }}">

    <!--THEME STYLE-->
    <link href="mozarc_work/{{ config('theme.selected_theme_css') }} " rel="stylesheet">

    <!--USERS CUSTON CSS FILE-->
    <link href="mozarc_work/public/css/custom.css?v={{ config('system.versioning') }}" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="mozarc_work/public/js/core/head.js?v={{ config('system.versioning') }}"></script>
