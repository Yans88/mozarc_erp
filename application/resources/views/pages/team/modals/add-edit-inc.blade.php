...
<div class="row">
    <div class="col-lg-12">
        ...
        <!--[edit] phone-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.phone')) }}</label>
            <div class="col-sm-12 col-lg-9">
        ...
        @if (auth()->user()->is_admin && @request('type') != 'profile')
            ...
            <div class="form-group form-group-checkbox row">
                ...
                <div class="col-8 text-left p-t-5">
                    <input type="checkbox" id="pref_email_notifications" name="pref_email_notifications"
                        class="filled-in chk-col-light-blue" {{ runtimePrechecked($user->pref_email_notifications ?? '') }}>
        ...
        <div class="hidden" id="edit_team_password_section">
            <div class="form-group row">
                <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.password')) }}</label>
                <div class="col-sm-12 col-lg-9">
                    <input type="password" class="form-control form-control-sm" name="password">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.confirm')) }}</label>
                <div class="col-sm-12 col-lg-9">
