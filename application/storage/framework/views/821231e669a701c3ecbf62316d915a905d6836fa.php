            ...
            <table class="table table-bordered table-sm">
                ...
                <tbody>
                    ...
                    <tr>
						...
						<?php if($task->task_private > 0): ?>
							<tr>

								<td><?php echo e(cleanLang(__('lang.private'))); ?></td>
						...
						<?php if($task->task_leadid > 0): ?>
							<tr>

								<td><?php echo e(cleanLang(__('lang.lead'))); ?></td>

								<td><strong><a href="<?php echo e(urlResource('/leads/v/'.$task->task_leadid.'/'.$task->lead_company_name)); ?>"

											target="_blank"><?php echo e($task->task_leadid); ?></a></strong>
						...
						<?php if($task->task_clientid  > 0): ?>
							<tr>

								<td><?php echo e(cleanLang(__('lang.client'))); ?></td>

								<td><strong><a href="<?php echo e(urlResource('/clients/'.$task->task_clientid)); ?>"

											target="_blank">#<?php echo e($task->task_clientid); ?></a></strong>
						...
						<?php if($task->task_departmentid  > 0): ?>
							<tr>

								<td><?php echo e(cleanLang(__('lang.department'))); ?></td>

								<td><strong><?php echo e($task->role_name); ?></strong>
    ...
    </div><?php /**PATH C:\xampp\htdocs\mozarc_work\application\resources\views/pages/task/rightpanel.blade.php ENDPATH**/ ?>