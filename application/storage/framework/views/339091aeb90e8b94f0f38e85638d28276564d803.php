...
<tr id="client_<?php echo e($client->client_id); ?>">
    ...
    <td class="clients_col_category" id="clients_col_category_<?php echo e($client->client_id); ?>">
        <?php 
        $list = explode(",",$client->client_categoryid );

        ?>
        <!--category-->
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(array_search($category->category_id, $list) !== false): ?>
        <span class="label label-outline-default"><?php echo e(str_limit($category->category_name, 15)); ?></span>
...
<!--each row--><?php /**PATH C:\xampp\htdocs\mozarc_work\application\resources\views/pages/clients/components/table/ajax.blade.php ENDPATH**/ ?>