<head>
    ...
    <script src="mozarc_work/public/vendor/js/vendor.header.js?v=<?php echo e(config('system.versioning')); ?>"></script>

    <!--BOOTSTRAP-->
    <link href="mozarc_work/public/vendor/css/bootstrap/bootstrap.min.css" rel="stylesheet">
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="mozarc_work/public/vendor/css/vendor.css?v=<?php echo e(config('system.versioning')); ?>">

    <!--ICONS-->
    <link rel="stylesheet" href="mozarc_work/public/vendor/fonts/growcrm-icons/styles.css?v=<?php echo e(config('system.versioning')); ?>">

    <!--THEME STYLE-->
    <link href="mozarc_work/<?php echo e(config('theme.selected_theme_css')); ?> " rel="stylesheet">

    <!--USERS CUSTON CSS FILE-->
    <link href="mozarc_work/public/css/custom.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="mozarc_work/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
</head><?php /**PATH C:\xampp\htdocs\mozarc_work\application\resources\views/layout/header.blade.php ENDPATH**/ ?>